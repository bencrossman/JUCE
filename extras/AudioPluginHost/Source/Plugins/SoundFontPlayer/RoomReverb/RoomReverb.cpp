...
RoomReverb::RoomReverb()
{
    ...
    setLateLevel(30.0f);
    setStereoWidth(90.0f);
    setEarlyDamping(8000.0f);
    setEarlyRoomSize(45.0f);
    setLateDamping(8000.0f);
    setLateDiffusion(64.0f);
    setLatePredelay(12.0f);
    setLateRoomSize(45.0f);
    setLateDecay(1.2f);
    setLateSpin(0.5f);
    setLateWander(40.0f);
}
